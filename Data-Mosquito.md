...
Please note that the data available is not exhaustive. Data has been compiled through partnerships with local public health agencies and represents a subset of jurisdictions from some states. Also note that differences in available mosquito data may exist between agencies (e.g., time period of available historical data).
